    ...
    public class RectangleTracker : UMatProcessorFilter
    {
        ...
        private RectangularObject[] FindObjectByBlankingKnownObjects(bool occlusionTracking, UMat image, ref UMat outputImage, DateTime updateTime, RectangularObject[] objects, RectangularObject obj = null, bool useROI = false)
        {
            ...
            if (useROI)
            {
                ...
                maskImage.SetTo(Rgbs.Black.MCvScalar);
        ...
        private void UpdateOccludedObjects(/*Image<Rgb, byte>*/UMat u_image, ref UMat outputImage, DateTime updateTime, RectangularObject[] objects)
        {
            ...
            for (int i = 0; i < occludedObjects.Length; i++ )
            {
                UpdateOccludedObject(u_image, ref enclosedOutputImage, updateTime, objects, occludedObjects[i]);
            }
        ...
        private void UpdateOccludedObject(/*Image<Rgb, byte>*/UMat u_image, ref UMat outputImage, DateTime updateTime, RectangularObject[] objects, RectangularObject obj)
        {
            ...
            mask.SetTo(Rgbs.Black.MCvScalar);
            UMat depthPatchesImage = new UMat(imageHeight, imageWidth, DepthType.Cv8U, 1);
            depthPatchesImage.SetTo(Rgbs.Black.MCvScalar);
            ...
            CvInvoke.Threshold(_depthImage, depthMapBinary, 127, 255, ThresholdType.BinaryInv); // 255 == new Gray(255) ???
            ...
            originPixels.SetTo(Rgbs.Black.MCvScalar);
